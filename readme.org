...
** Installation
1. Download [[ob-racket.el]] and place it in your =load-path=
2. When using [[https://jwiegley.github.io/use-package/][use-package]] add the following to your =init.el= file:
   #+begin_src elisp
